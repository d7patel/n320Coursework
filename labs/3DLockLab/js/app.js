...
function createScene() {
  ...
  var lesserSphere = BABYLON.MeshBuilder.CreateSphere("sphere2", {diameter: .5}, scene);
  lesserSphere.position.x = 0.9;

  var lesser2Sphere = BABYLON.MeshBuilder.CreateSphere("sphere3", {diameter: .5}, scene);
  lesser2Sphere.position.x = 1.8;
