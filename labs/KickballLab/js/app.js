...
function createScene(){
    ...
    //basic scene setup
    camera = new BABYLON.UniversalCamera("US", new BABYLON.Vector3(0,0,-15), scene);

    var light = new BABYLON.DirectionalLight("lighty", new BABYLON.Vector3(0,-0.2,0.2), scene);
    ...
    //setup the ground for ball to exist on
